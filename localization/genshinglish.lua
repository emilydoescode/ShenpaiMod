return {
    descriptions={
        Back={
            ...
            b_checkered={
                ...
                text={
                    "Start run with",
                    "{C:attention}26{C:spades} Pyro{} and",
                    "{C:attention}26{C:hearts} Dendro{} in deck",
                },
            },
            b_erratic={
                name="Erratic Deck",
        ...
        Joker={
            ...
            j_ancient={
                ...
                text={
                    ...
                    "{s:0.8}element changes at end of round",
                },
            },
            j_arrowhead={
                name="Arrowhead",
                text={
                    "Played cards with",
                    "{C:spades}Pyro{} element give",
                    "{C:chips}+#1#{} Chips when scored",
                },
                unlock={
                    "Have at least {E:1,C:attention}#1#",
                    "cards with {E:1,C:attention}#2#",
                    "element in your deck",
                },
            },
            j_astronomer={
                name="Astronomer",
            ...
            j_bloodstone={
                ...
                text={
                    ...
                    "played cards with",
                    "{C:hearts}Dendro{} element to give",
            ...
            j_flower_pot={
                ...
                text={
                    ...
                    "hand contains a",
                    "{C:diamonds}Geo{} card, {C:clubs}Electro{} card,",
                    "{C:hearts}Dendro{} card, and {C:spades}Pyro{} card",
                },
                unlock={
                    "Reach Ante",
            ...
            j_seeing_double={
                ...
                text={
                    "{X:mult,C:white} X#1# {} Mult if played",
                    "hand has a scoring",
                    "{C:clubs}Electro{} card and a scoring",
                    "card of any other {C:attention}element",
                },
                unlock={
                    "Play a hand",
                    "that contains",
            ...
            j_shoot_the_moon={
                ...
                unlock={
                    "Play every {E:1,C:attention}Dendro",
                    "in your deck in",
                    "a single round",
                },
            },
            ...
            j_smeared={
                name="Smeared Joker",
                text={
                    "{C:hearts}Dendro{} and {C:diamonds}Geo",
                    "count as the same element,",
                    "{C:spades}Pyro{} and {C:clubs}Electro",
                    "count as the same element",
                },
                unlock={
    ...
    misc={
        ...
        dictionary={
            ...
            ph_1_level="+1 Level",
            ph_4_7_of_clubs="four 7 of Electro",
        ...
        poker_hand_descriptions={
            ...
            Flush={
                "5 cards that share the same element",
            },
            ["Flush Five"]={
                "5 cards with the same rank and element",
            },
            ["Flush House"]={
                "A Three of a Kind and a Pair with",
                "all cards sharing the same element",
            },
            ["Four of a Kind"]={
